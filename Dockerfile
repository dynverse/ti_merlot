...
RUN apt-get install -y python3-sklearn python3-scipy python3-numpy python3-pandas

RUN pip3 install --no-cache-dir cython
RUN pip3 install --no-cache-dir git+https://github.com/soedinglab/csgraph_mod
